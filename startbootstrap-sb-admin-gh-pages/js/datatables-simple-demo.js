...
function random() {
    ...
    const randomNum = Math.floor(Math.random() * (tableData.length - 1))
...
document.getElementById("ageRangeForm").addEventListener("submit", function (event) {
    ...
    document.getElementById("personInfo").innerHTML = "Name: " + filteredData[randomNumber].name +"<br>"
    document.getElementById("personInfo").innerHTML += "Position: " + filteredData[randomNumber].position +"<br>"
    document.getElementById("personInfo").innerHTML += "Office: " + filteredData[randomNumber].office +"<br>"
    document.getElementById("personInfo").innerHTML += "Age: " + filteredData[randomNumber].age +"<br>"
    document.getElementById("personInfo").innerHTML += "Start Date: " + filteredData[randomNumber].startDate +"<br>"
    document.getElementById("personInfo").innerHTML += "Salary: " + filteredData[randomNumber].salary 
    
    const totalSalary = filteredData.reduce((sum, row) => {
        //regular expression, turns any string into any other string? removes the elements in [] with ""
